...
void setupColors(){
    ...
    init_pair(PAIR_COLOR_BOMB, COLOR_CYAN, COLOR_BLACK);
    init_pair(PAIR_COLOR_HEART, COLOR_CYAN, COLOR_BLACK);
    init_pair(PAIR_COLOR_ALIENS_REMAINING, COLOR_CYAN, COLOR_BLACK);
